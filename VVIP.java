public class VVIP extends Karaoke implements Charge
{
	private String rusak, ket, nama;
	private String bonus = "Voucher belanja Rp. 50.000";
	private int no, pil, noruang;
	private double diskon, lama, tambah, hours, total, persen, total_denda, selesai;
	public double harga = 60000;
	private double pajak = 10000;
	private double denda;
	public Perkap perkap;
	
	public VVIP(Customer[] customer, int no, double lama, double hours, int noruang, String nama)
	{
		super(customer);
		this.no = no;
		this.lama = lama;
	...
	public String getBonus()
	{
		if(this.lama>=5)
		{
			return "Anda mendapat "+this.bonus;
		}else
		{
			return "Anda tidak mendapat bonus";
		}
	}
	...
	public double Total()
	{
		Denda(pil);
		Diskon();
		return this.total = (this.harga*this.lama)+this.denda-this.diskon-(customer[getNo()].Bonus()*this.lama)+this.pajak;
	}
