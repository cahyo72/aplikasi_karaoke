public class VIP extends Karaoke implements Charge
{
	...
	public double harga = 40000;
	public double pajak = 5000;
	private double denda=0;
	public Perkap perkap;
	
	public VIP(Customer[] customer, int no, double lama, double hours, int noruang, String nama)
	{
		super(customer);
		this.no = no;
		this.lama = lama;
